...
```{r}
# Get rid of Cax_Id so it does not spoil the data
test_n <- subset(test_new, select = -CAX_ID)
test_n
...
pca.test <- dummy.data.frame(subset(test_n, select = -Dependent), names = result$my.fct.names)
